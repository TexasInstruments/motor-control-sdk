...
<tr>
    ...
    <td>
        ...
        - Double Update<br>
        - Up to nine channel support using single PRU mode
...
/* Register & enable ICSSG PRU SDFM interrupt for channel 0 */
...
/* SDFM IRQ handler for Channel 0 */
void sdfmIrqHandlerCh0(void *args)
{
    ...
    gSdfmChSamples[SDFM_CHANNEL0][gSdfmIdxCnt[SDFM_CHANNEL0]] =
        SDFM_getFilterData(gPruIcssSdfmHandle, SDFM_CHANNEL0);
...
#define ICSS_SDFM_TRIGGER_EVNT_CH1  (4+18)   /* PRU Event 22 */
#define ICSS_SDFM_TRIGGER_EVNT_CH2  (5+18)   /* PRU Event 23 */
