...
<tr>
    ...
    <td>Contains all initialization of test structures and variables with datalog functionality</td>
</tr>
<tr>
    <td>datalog.c</td>
...
<tr>
    <td>datalog.h</td>
    <td>datalog library header file at "${SDK_INSTALL_PATH}/source/rtlibs/utilities/datalog/include"</td>
</tr>
<tr>
    <td>datalog_input.h</td>
    <td>User configurable datalog header file needed to be changed at "${SDK_INSTALL_PATH}/source/rtlibs/utilities/datalog/include"</td>
</tr>
<tr>
...
\cond (SOC_AM263X || SOC_AM263PX)
 ...
 Example folder | examples/rtlibs/utilities/datalog
