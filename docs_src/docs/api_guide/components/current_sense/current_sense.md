...
- Fast detect for rapid over-current detection (4-32 bit sliding window)
...
- Task duration when only single update is enabled
  - 320ns, without Arm® Cortex®-R5F interrupt and samples stored in TCM memory
  - 328ns, with Arm® Cortex®-R5F interrupt and samples stored in TCM memory
...
- Task duration when double update is enabled
  - 320ns, without Arm® Cortex®-R5F interrupt and samples stored in TCM memory
  - 336ns, with Arm® Cortex®-R5F interrupt and samples stored in TCM memory.
