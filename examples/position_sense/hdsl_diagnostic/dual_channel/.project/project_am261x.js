...
const includes_freertos_r5f = {
    common: [
        ...
        "${MOTOR_CONTROL_SDK_PATH}/examples/position_sense/hdsl_diagnostic",
        "${MOTOR_CONTROL_SDK_PATH}/source/position_sense/hdsl/firmware/freerun_225_mhz",
        "${MOTOR_CONTROL_SDK_PATH}/source/position_sense/hdsl/firmware/sync_225_mhz",
    ],
};
...
const libs_freertos_r5f = {
    common: [
        ...
        "motorcontrol_hdsl.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "hdsl_diagnostic_dual_channel";
