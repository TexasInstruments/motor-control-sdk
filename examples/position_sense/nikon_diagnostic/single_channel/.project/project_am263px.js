...
const libdirs_freertos = {
    common: [
        ...
        "${MOTOR_CONTROL_SDK_PATH}/source/position_sense/nikon/lib",
    ],
};
...
const includes_freertos_r5f = {
    common: [
        ...
        "${MOTOR_CONTROL_SDK_PATH}/mcu_plus_sdk/source/kernel/freertos/config/am263px/r5f",
        "${MOTOR_CONTROL_SDK_PATH}/examples/position_sense/nikon_diagnostic",
        "${MOTOR_CONTROL_SDK_PATH}/source/position_sense/nikon/firmware/single_channel",
    ],
};
...
const libs_freertos_r5f = {
    common: [
        ...
        "motorcontrol_nikon.am263px.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLE_MOTORCONTROL_NIKON";
...
function getComponentProperty() {
    ...
    property.name = "nikon_diagnostic_single_channel";
