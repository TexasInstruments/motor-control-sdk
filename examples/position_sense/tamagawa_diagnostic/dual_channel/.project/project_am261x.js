...
const includes_freertos_r5f = {
    common: [
        ...
        "${MOTOR_CONTROL_SDK_PATH}/source/position_sense/tamagawa/firmware/single_channel",
    ],
};
...
const libs_freertos_r5f = {
    common: [
        ...
        "motorcontrol_tamagawa.am261x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const defines_r5f = {
    common: [
        "SOC_AM261X",
        "TAMAGAWA_DUAL_PRU_SLICE_ENABLE",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "tamagawa_diagnostic_dual_channel";
