...
const includes_freertos_r5f = {
    common: [
        ...
        "${MOTOR_CONTROL_SDK_PATH}/examples/current_sense/icss_sdfm_three_channel_single_pru_continuous_mode",
...
function getComponentProperty() {
    ...
    property.name = "icss_sdfm_three_channel_single_pru_continuous_mode";
