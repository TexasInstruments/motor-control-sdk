...
const includes_freertos_r5f = {
    common: [
        ...
        "${MOTOR_CONTROL_SDK_PATH}/examples/current_sense/icss_sdfm_nine_channel_load_share_continuous_mode",
...
function getComponentProperty() {
    ...
    property.name = "icss_sdfm_nine_channel_load_share_continuous_mode";
