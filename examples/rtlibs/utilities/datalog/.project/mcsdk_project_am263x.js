...
const filedirs = {
    common: [
        "..",       /* core_os_combo base */
        "../../..",       /* Example base */
        "../../../../../../../source/rtlibs/utilities/datalog/source" /* Library source file base */
    ],
};
...
const includes_nortos_r5f = {
    common: [
        "${MOTOR_CONTROL_SDK_PATH}/source/rtlibs/utilities/datalog/include",
        "${MOTOR_CONTROL_SDK_PATH}/examples/rtlibs/utilities/datalog",
    ],
};
