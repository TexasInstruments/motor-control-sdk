...
SECTIONS
{
    ...
    .gSddfChSampsRaw       			: {} align(4) > R5F_TCMB0_SDDF_0_0
    ...
    .gEnDatChInfo       : {} align(4) > R5F_TCMB0_ENC

    .critical_code		: {} palign(4) > R5F_TCMB0
    .critical_data		: {} palign(8) > R5F_TCMB0
    
    .gCtrlVars          : {} palign(8) > MSRAM_CTRL_VARS_0_0

    .gSharedPrivStep    : {} palign(8) > USER_SHM_MEM
    .gSharedPruHandle   : {} palign(8) > USER_SHM_MEM
    .gEtherCatCia402	: {} palign(4) > MSRAM_NO_CACHE
}
...
MEMORY
{
    ...
    R5F_TCMB0_SDDF_0_1 : ORIGIN = 0x41010080 , LENGTH = 0x80
