...
function getmakefilePruPostBuildSteps(cpu, board)
{
    ...
    switch(cpu)
    {
        case "icss_m1_pru1":
            postBuildSteps = [
                "$(CG_TOOL_ROOT)/bin/hexpru --diag_wrap=off --array --array:name_prefix=HdslFirmwareSyncPru1 -o hdsl_receiver_sync_225_mhz_pru1_bin.h  hdsl_receiver_sync_225_mhz_" + board + "_" + cpu + "_fw_ti-pru-cgt.out;"+
        ...
        case "icss_m1_pru0":
            postBuildSteps = [
                "$(CG_TOOL_ROOT)/bin/hexpru --diag_wrap=off --array --array:name_prefix=HdslFirmwareSyncPru0 -o hdsl_receiver_sync_225_mhz_pru0_bin.h  hdsl_receiver_sync_225_mhz_" + board + "_" + cpu + "_fw_ti-pru-cgt.out;"+
