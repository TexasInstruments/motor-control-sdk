    ...
    switch(cpu)
    {
        case "icss_g0_pru1":
            postBuildSteps = [
                ...
                "$(CAT) ${MCU_PLUS_SDK_PATH}/source/pru_io/firmware/pru_load_bin_copyright.h hdsl_receiver_multichannel_sync_mode_rtu_pru1_bin.h > ${MOTOR_CONTROL_SDK_PATH}/source/position_sense/hdsl/firmware/multichannel_ch0_sync_mode/hdsl_receiver_multichannel_sync_mode_rtu_pru1_bin.h;"+ 
        ...
        case "icss_g0_pru0":
            postBuildSteps = [
                ...
                "$(CAT) ${MCU_PLUS_SDK_PATH}/source/pru_io/firmware/pru_load_bin_copyright.h hdsl_receiver_multichannel_sync_mode_rtu_pru0_bin.h > ${MOTOR_CONTROL_SDK_PATH}/source/position_sense/hdsl/firmware/multichannel_ch0_sync_mode/hdsl_receiver_multichannel_sync_mode_rtu_pru0_bin.h;"+ 
...
function getccsPruPostBuildSteps(cpu, board)
{
    ...
    switch(cpu)
    {
        case "icss_g0_pru1":
            postBuildSteps = [
                "$(CG_TOOL_ROOT)/bin/hexpru --diag_wrap=off --array --array:name_prefix=Hiperface_DSL_SYNC2_0_RTU -o hdsl_receiver_multichannel_sync_mode_rtu_pru1_bin.h  hdsl_receiver_multichannel_ch0_sync_mode_" + board + "_" + cpu + "_fw_ti-pru-cgt.out;"+ 
                "if ${CCS_HOST_OS} == linux cat ${MCU_PLUS_SDK_PATH}/source/pru_io/firmware/pru_load_bin_copyright.h hdsl_receiver_multichannel_sync_mode_rtu_pru1_bin.h > ${MOTOR_CONTROL_SDK_PATH}/source/position_sense/ hdsl/firmware/multichannel_ch0_sync_mode/hdsl_receiver_multichannel_sync_mode_rtu_pru1_bin.h;"+ 
        ...
        case "icss_g0_pru0":
            postBuildSteps = [
                "$(CG_TOOL_ROOT)/bin/hexpru --diag_wrap=off --array --array:name_prefix=Hiperface_DSL_SYNC2_0_RTU -o hdsl_receiver_multichannel_sync_mode_rtu_pru0_bin.h  hdsl_receiver_multichannel_ch0_sync_mode_" + board + "_" + cpu + "_fw_ti-pru-cgt.out;"+ 
                "if ${CCS_HOST_OS} == linux cat ${MCU_PLUS_SDK_PATH}/source/pru_io/firmware/pru_load_bin_copyright.h hdsl_receiver_multichannel_sync_mode_rtu_pru0_bin.h > ${MOTOR_CONTROL_SDK_PATH}/source/position_sense/ hdsl/firmware/multichannel_ch0_sync_mode/hdsl_receiver_multichannel_sync_mode_rtu_pru0_bin.h;"+ 
...
function getComponentProperty() {
    ...
    property.name = "hdsl_receiver_multichannel_ch0_sync_mode";
