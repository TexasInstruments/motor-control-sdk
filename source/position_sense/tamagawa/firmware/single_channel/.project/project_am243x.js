...
function getmakefilePruPostBuildSteps(cpu, board)
{
    ...
    switch(cpu)
    {
        case "icss_g0_pru0":
            ...
            "$(CAT) ${MOTOR_CONTROL_SDK_PATH}/source/pru_ti_text_file_license_copyright.h tamagawa_receiver_single_channel_pru0_bin.h > ${MOTOR_CONTROL_SDK_PATH}/source/position_sense/tamagawa/firmware/single_channel/tamagawa_receiver_single_channel_pru0_bin.h;"+ 
        ...
        case "icss_g0_pru1":
            ...
            "$(CAT) ${MOTOR_CONTROL_SDK_PATH}/source/pru_ti_text_file_license_copyright.h tamagawa_receiver_single_channel_pru1_bin.h > ${MOTOR_CONTROL_SDK_PATH}/source/position_sense/tamagawa/firmware/single_channel/tamagawa_receiver_single_channel_pru1_bin.h;"+ 
...
function getccsPruPostBuildSteps(cpu, board)
{
    ...
    switch(cpu)
    {
        case "icss_g0_pru0":
            postBuildSteps = ["$(CG_TOOL_ROOT)/bin/hexpru --diag_wrap=off --array --array:name_prefix=TamagawaFirmwarePru0 -o tamagawa_receiver_single_channel_pru0_bin.h tamagawa_single_channel_" + board + "_" + cpu + "_fw_ti-pru-cgt.out;"+ 
            "if ${CCS_HOST_OS} == linux cat ${MOTOR_CONTROL_SDK_PATH}/source/pru_ti_text_file_license_copyright.h tamagawa_receiver_single_channel_pru0_bin.h > ${MOTOR_CONTROL_SDK_PATH}/source/position_sense/tamagawa/firmware/single_channel/tamagawa_receiver_single_channel_pru0_bin.h;"+ 
            "if ${CCS_HOST_OS} == linux rm tamagawa_receiver_single_channel_pru0_bin.h;"+
            "if ${CCS_HOST_OS} == win32  $(CCS_INSTALL_DIR)/utils/cygwin/cat ${MOTOR_CONTROL_SDK_PATH}/source/pru_ti_text_file_license_copyright.h tamagawa_receiver_single_channel_pru0_bin.h > ${MOTOR_CONTROL_SDK_PATH}/source/position_sense/tamagawa/firmware/single_channel/tamagawa_receiver_single_channel_pru0_bin.h;"+ 
            "if ${CCS_HOST_OS} == win32  $(CCS_INSTALL_DIR)/utils/cygwin/rm tamagawa_receiver_single_channel_pru0_bin.h;"]
            break;
        case "icss_g0_pru1":
            postBuildSteps = ["$(CG_TOOL_ROOT)/bin/hexpru --diag_wrap=off --array --array:name_prefix=TamagawaFirmwarePru1 -o tamagawa_receiver_single_channel_pru1_bin.h tamagawa_single_channel_" + board + "_" + cpu + "_fw_ti-pru-cgt.out;"+ 
            "if ${CCS_HOST_OS} == linux cat ${MOTOR_CONTROL_SDK_PATH}/source/pru_ti_text_file_license_copyright.h tamagawa_receiver_single_channel_pru1_bin.h > ${MOTOR_CONTROL_SDK_PATH}/source/position_sense/tamagawa/firmware/single_channel/tamagawa_receiver_single_channel_pru1_bin.h;"+ 
            "if ${CCS_HOST_OS} == linux rm tamagawa_receiver_single_channel_pru1_bin.h;"+
            "if ${CCS_HOST_OS} == win32  $(CCS_INSTALL_DIR)/utils/cygwin/cat ${MOTOR_CONTROL_SDK_PATH}/source/pru_ti_text_file_license_copyright.h tamagawa_receiver_single_channel_pru1_bin.h > ${MOTOR_CONTROL_SDK_PATH}/source/position_sense/tamagawa/firmware/single_channel/tamagawa_receiver_single_channel_pru1_bin.h;"+ 
