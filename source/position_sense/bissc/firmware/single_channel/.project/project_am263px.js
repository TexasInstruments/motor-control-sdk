...
function getccsPruPostBuildSteps(cpu, board)
{
    ...
    switch(cpu)
    {
        case "icss_m0_pru0":
            postBuildSteps =[
            "$(CG_TOOL_ROOT)/bin/hexpru --diag_wrap=off --array --array:name_prefix=BiSSFirmwarePru0 -o bissc_receiver_pru0_bin.h bissc_peripheral_interface_single_ch_" + board + "_" + cpu + "_fw_ti-pru-cgt.out;"+
        ...
        case "icss_m0_pru1":
            postBuildSteps =[
            "$(CG_TOOL_ROOT)/bin/hexpru --diag_wrap=off --array --array:name_prefix=BiSSFirmwarePru1 -o bissc_receiver_pru1_bin.h bissc_peripheral_interface_single_ch_" + board + "_" + cpu + "_fw_ti-pru-cgt.out;"+
