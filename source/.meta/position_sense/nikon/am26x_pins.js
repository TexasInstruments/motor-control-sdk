...
function getInterfacePinList(inst)
{
    ...
    pinList.push({ pinName: Slice.toString()+"_GPIO2", displayName: "NIKON_CHANNEL0_TX_ENABLE", rx: false});
    pinList.push({ pinName: Slice.toString()+"_GPIO1", displayName: "NIKON_CHANNEL0_TX", rx: false});
    pinList.push({ pinName: Slice.toString()+"_GPIO0", displayName: "NIKON_CHANNEL0_CLK", rx: false});
    pinList.push({ pinName: Slice.toString()+"_GPIO9", displayName: "NIKON_CHANNEL0_RX", rx: true});

    pinList.push({ pinName: Slice.toString()+"_GPIO5", displayName: "NIKON_CHANNEL1_TX_ENABLE", rx: false});
    pinList.push({ pinName: Slice.toString()+"_GPIO4", displayName: "NIKON_CHANNEL1_TX", rx: false});
