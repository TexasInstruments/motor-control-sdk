...
function getInterfacePinList(inst)
{
    ...
    pinList.push({ pinName: Slice.toString()+"_GPIO2", displayName: "HDSL_CHANNEL0_TX_ENABLE", rx: false});
    pinList.push({ pinName: Slice.toString()+"_GPIO1", displayName: "HDSL_CHANNEL0_TX", rx: false});
    pinList.push({ pinName: Slice.toString()+"_GPIO0", displayName: "HDSL_CHANNEL0_CLK", rx: false});
    pinList.push({ pinName: Slice.toString()+"_GPIO9", displayName: "HDSL_CHANNEL0_RX", rx: true});

    pinList.push({ pinName: Slice.toString()+"_GPIO5", displayName: "HDSL_CHANNEL1_TX_ENABLE", rx: false});
    pinList.push({ pinName: Slice.toString()+"_GPIO4", displayName: "HDSL_CHANNEL1_TX", rx: false});
    pinList.push({ pinName: Slice.toString()+"_GPIO3", displayName: "HDSL_CHANNEL1_CLK", rx: false});
