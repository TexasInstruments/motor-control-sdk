...
config = config.concat([
    ...
    },
    {
        ...
        description: "Generated SDFM clock frequency from the selected clock source (IEP, ECAP, or GPIO1). It generates a CONFIG_SDFM0_CLOCK_VALUE macro in ti_drivers_config.h for use in application code. Note: Clock divider values need to be set manually in application initialization based on this frequency.",
        hidden: true,
        default: 20000000,
